# 1 "spiral_matrix_V1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 349 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "spiral_matrix_V1.c" 2
...
free(matrix);
t = clock() - t;
double time_taken = ((double)t)/((__clock_t) 1000000);
